...
<div class="relative isolate overflow-hidden bg-slate-950 py-16 sm:py-24 border-b border-slate-900">
  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:mx-0">
      <h2 class="text-3xl font-bold tracking-tight text-white sm:text-5xl font-display">공지사항</h2>
...
<div class="flex-grow flex flex-col bg-slate-950 text-slate-100">
  ...
  <div class="border-b border-slate-900 bg-slate-950/80 sticky top-20 z-40 backdrop-blur-md">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <nav class="-mb-px flex space-x-8" aria-label="Tabs">
        ...
        <a href="<?=$default_path?>/community/notice.php" class="border-brand-500 text-brand-400 border-b-2 py-4 px-1 text-sm font-semibold" aria-current="page">공지사항</a>
      </nav>
    </div>
  </div>
  <!-- 상단 탭메뉴 [E] -->
  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8 py-12 flex-grow w-full">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between border-b border-slate-900 pb-5 mb-8 gap-4">
      <div>
        <h3 class="text-xl font-bold text-white font-display">공지사항 목록</h3>
      </div>
      <div class="flex items-center gap-x-2 text-xs text-slate-400">
        ...
        <span>고객센터</span>
        <span class="text-slate-700"><i class="fa fa-angle-right"></i></span>
        <span class="text-brand-400 font-semibold">공지사항</span>
      </div>
    </div>
    ...
    <div class="space-y-8">
        ...
        <table class="min-w-full divide-y divide-slate-800">
          <thead class="bg-slate-900/80">
            <tr>
              ...
              <th scope="col" class="py-4 px-6 text-center text-xs font-semibold text-slate-350 tracking-wider w-36">작성일자</th>
            </tr>
          </thead>
          <tbody class="divide-y divide-slate-850 text-sm text-slate-300">
            ...
            <tr class="hover:bg-slate-800/30 transition cursor-pointer" 
              ...
              <td class="py-4 px-4 text-center text-slate-500 font-mono">1</td>
              <td class="py-4 px-6 text-left">
                <span class="hover:text-brand-400 transition font-medium text-slate-200">조이코리아 홈페이지가 오픈되었습니다.</span>
              </td>
              <td class="py-4 px-6 text-center text-slate-400 font-mono">2020-09-12</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div class="flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-slate-900 pt-6">
        <div></div> <!-- Spacer -->
        <!-- No pages pagination but we show dummy structured clean block for uniformity -->
        <div class="text-xs text-slate-500 font-mono">Showing 1 to 1 of 1 entries</div>
        <div></div> <!-- Spacer -->
      </div>
