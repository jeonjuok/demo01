...
<section class="relative mx-auto max-w-7xl px-6 sm:px-8 lg:px-12 pt-16 pb-8">
  <div class="border-b border-slate-900 pb-10">
    ...
    <h1 class="mt-2 font-display text-4xl font-extrabold tracking-tight text-white sm:text-5xl">오시는 길</h1>
    <p class="mt-4 text-base text-slate-400">조이코리아 강남본사 및 하남지사로 찾아오시는 길을 안내해 드립니다.</p>
  </div>
</section>
<!-- 상단 서브 히어로 섹션 [E]-->
...
<div class="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12 pb-24">
  ...
  <div class="mb-12 border-b border-slate-900">
     <nav class="-mb-px flex space-x-8" aria-label="Tabs">
       ...
       <a href="<?=$default_path?>/company/map.php" class="border-brand-500 text-brand-400 whitespace-nowrap border-b-2 py-4 px-1 text-sm font-semibold transition">오시는 길</a>
     </nav>
  </div>
  <!-- 상단 탭 메뉴 [E] -->
  ...
  <div class="space-y-12">
     ...
     <div class="relative overflow-hidden rounded-3xl border border-slate-900 bg-slate-950 h-[400px] sm:h-[480px] shadow-2xl">
     ...
     <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
        ...
        <!-- 강남본사 카드 -->
        <div class="rounded-3xl border border-slate-900 bg-slate-900/10 p-8 space-y-6 hover:border-slate-800 transition duration-300">
           <div class="flex items-center gap-3">
              ...
              <h3 class="font-display text-xl font-bold text-white">강남본사</h3>
           </div>
           
           <div class="space-y-4 text-sm text-slate-400">
              <div class="space-y-1">
                 <span class="text-xs font-semibold text-slate-500 uppercase tracking-wider">주소</span>
                 <p class="text-slate-200 leading-relaxed">서울특별시 강남구 영동대로 702 (청담동, 화천빌딩) 803호</p>
              </div>
              
              <div class="space-y-1">
                 <span class="text-xs font-semibold text-slate-500 uppercase tracking-wider">대표 연락처</span>
                 <p class="text-slate-200"><a href="tel:1599-2833" class="hover:text-brand-400 transition">1599-2833</a></p>
              </div>

              <div class="space-y-1">
                 <span class="text-xs font-semibold text-slate-500 uppercase tracking-wider">지하철 대중교통 이용 시</span>
                 <p class="text-slate-200">7호선 청담역 하차 후 <strong class="text-brand-400 font-semibold">14번 출구</strong> 이용 도보 이동</p>
              </div>
           </div>
        </div>
        ...
        <div class="rounded-3xl border border-slate-900 bg-slate-900/10 p-8 space-y-6 hover:border-slate-800 transition duration-300">
           <div class="flex items-center gap-3">
              ...
              <h3 class="font-display text-xl font-bold text-white">하남지사 (해외명품사업부)</h3>
           </div>
           
           <div class="space-y-4 text-sm text-slate-400">
              <div class="space-y-1">
                 <span class="text-xs font-semibold text-slate-500 uppercase tracking-wider">주소</span>
                 <p class="text-slate-200 leading-relaxed">경기도 하남시 미사강변서로 25 (미사테스타타워) 1039호</p>
              </div>
              
              <div class="space-y-1">
                 <span class="text-xs font-semibold text-slate-500 uppercase tracking-wider">지사 연락처</span>
                 <p class="text-slate-200"><a href="tel:1599-6933" class="hover:text-brand-400 transition">1599-6933</a></p>
              </div>

              <div class="space-y-1">
                 <span class="text-xs font-semibold text-slate-500 uppercase tracking-wider">주요 업무</span>
                 <p class="text-slate-200">해외 수입 명품 검수, 패킹, 물류 적재 및 공급망 직배송 센터 운영</p>
              </div>
           </div>
        </div>
