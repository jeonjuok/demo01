...
<section class="relative mx-auto max-w-7xl px-6 sm:px-8 lg:px-12 pt-16 pb-8">
  <div class="border-b border-slate-200 dark:border-slate-900 pb-10">
    ...
    <h1 class="mt-2 font-display text-4xl font-extrabold tracking-tight text-slate-900 dark:text-white sm:text-5xl">해외명품사업</h1>
    <p class="mt-4 text-base text-slate-600 dark:text-slate-400">이탈리아 최고 권위의 부티크 파트너십을 통해 정직하고 높은 품격의 럭셔리 라이프를 제안합니다.</p>
  </div>
</section>
<!-- 상단 서브 히어로 섹션 [E]-->
...
<div class="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12 pb-24">
  ...
  <div class="mb-12 border-b border-slate-200 dark:border-slate-900">
     <nav class="-mb-px flex space-x-8" aria-label="Tabs">
       <a href="<?=$default_path?>/luxury/business1.php" class="border-brand-600 dark:border-brand-500 text-brand-600 dark:text-brand-400 whitespace-nowrap border-b-2 py-4 px-1 text-sm font-semibold transition">사업소개</a>
  ...
  <div class="space-y-20">
     ...
     <!-- [1] 상단 명품 이미지 배너 리뉴얼 -->
     <div class="relative overflow-hidden rounded-3xl border border-slate-200 dark:border-slate-900 bg-slate-900 dark:bg-slate-950 h-64 sm:h-80 shadow-xl flex items-center px-8 sm:px-16">
        ...
        <div class="absolute inset-0 bg-gradient-to-r from-slate-900/90 via-slate-900/75 to-transparent dark:from-slate-950 dark:via-slate-950/80"></div>
     ...
     <div class="space-y-8">
        <div class="border-b border-slate-200 dark:border-slate-900 pb-3">
          <h4 class="font-display text-xl font-bold text-slate-900 dark:text-white">현지 인프라 및 오프라인 채널</h4>
        </div>
        
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
           
           <!-- 특징 1: 이탈리아 파트너사 -->
           <div class="rounded-3xl border border-slate-200 dark:border-slate-900 bg-white dark:bg-slate-900/10 p-8 space-y-4 hover:border-slate-300 dark:hover:border-slate-800 shadow-sm hover:shadow-2xl transition duration-300 flex gap-5 items-start">
              ...
              <div class="space-y-2">
                 <h5 class="text-lg font-bold text-slate-900 dark:text-white leading-none">70년 역사와 전통의 이탈리아 파트너사</h5>
                 <p class="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">신뢰도 높은 70년 전통의 이탈리아 현지 명품 부티크 총판과의 공식 독점 계약을 통하여, 전 상품을 위조 우려 없이 이탈리아 현지로부터 안전하게 직수입 공급하고 있습니다.</p>
              </div>
           </div>
           ...
           <div class="rounded-3xl border border-slate-200 dark:border-slate-900 bg-white dark:bg-slate-900/10 p-8 space-y-4 hover:border-slate-300 dark:hover:border-slate-800 shadow-sm hover:shadow-2xl transition duration-300 flex gap-5 items-start">
              ...
              <div class="space-y-2">
                 <h5 class="text-lg font-bold text-slate-900 dark:text-white leading-none">신세계, 갤러리아, AK 등 유명 백화점 유통</h5>
                 <p class="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">신세계백화점 및 갤러리아, AK백화점 온/오프라인 몰에 입점하여 판매하고 있으며, 시즌 오더로만 진행하여 매 시즌 가장 트렌디한 유럽 신상품들을 안전하게 바잉해 제공합니다.</p>
              </div>
           </div>
     ...
     <div class="space-y-8">
        <div class="border-b border-slate-200 dark:border-slate-900 pb-3">
          <h4 class="font-display text-xl font-bold text-slate-900 dark:text-white">온라인 비즈니스 경쟁력</h4>
        </div>
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
           ...
           <div class="rounded-3xl border border-slate-200 dark:border-slate-900 bg-white dark:bg-slate-900/10 p-8 space-y-4 hover:border-slate-300 dark:hover:border-slate-800 shadow-sm hover:shadow-2xl transition duration-300 flex gap-5 items-start">
              ...
              <div class="space-y-2">
                 <h5 class="text-lg font-bold text-slate-900 dark:text-white leading-none">온라인 커머스 전문가 그룹의 운영</h5>
                 <p class="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">조이코리아의 축적된 온라인 마케팅 솔루션을 명품 유통에도 고스란히 이식했습니다. 정밀한 검색 최적화 및 럭셔리 소비자 구매 패턴 분석을 바탕으로 판매를 극대화합니다.</p>
              </div>
           </div>
           ...
           <div class="rounded-3xl border border-slate-200 dark:border-slate-900 bg-white dark:bg-slate-900/10 p-8 space-y-4 hover:border-slate-300 dark:hover:border-slate-800 shadow-sm hover:shadow-2xl transition duration-300 flex gap-5 items-start">
              ...
              <div class="space-y-2">
                 <h5 class="text-lg font-bold text-slate-900 dark:text-white leading-none">명품 플랫폼 및 종합몰 입점 제휴</h5>
                 <p class="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">롯데, 현대, 신세계몰 등 대형 백화점 공식 몰은 물론 트렌디한 럭셔리 버티컬 플랫폼(발란, 트렌비, 머스트잇 등)까지 전방위적인 공급 협력망을 공고히 다지고 있습니다.</p>
              </div>
           </div>
     ...
     <div class="relative overflow-hidden rounded-3xl bg-slate-100 dark:bg-slate-900/40 border border-slate-200 dark:border-slate-900 p-8 sm:p-12 flex flex-col md:flex-row items-center justify-between gap-6">
        <div class="space-y-2 text-center md:text-left">
           <h4 class="font-display text-xl font-extrabold text-slate-900 dark:text-white">이태리 명품 비즈니스의 확실한 검증된 파트너</h4>
           <p class="text-sm text-slate-600 dark:text-slate-400">그란도노 명품 유통망 제휴 및 기업 제휴 오더에 대해 신속하게 답변 드리겠습니다.</p>
        </div>
