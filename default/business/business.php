...
<section class="relative mx-auto max-w-7xl px-6 sm:px-8 lg:px-12 pt-16 pb-8">
  <div class="border-b border-slate-900 pb-10">
    ...
    <h1 class="mt-2 font-display text-4xl font-extrabold tracking-tight text-white sm:text-5xl">운영쇼핑몰</h1>
    <p class="mt-4 text-base text-slate-400">단순 대행 입점이 아닌, 조이코리아가 브랜드사 공식 위탁 권한을 받아 직접 전담 운영하는 메이저 쇼핑몰 리스트입니다.</p>
  </div>
</section>
<!-- 상단 서브 히어로 섹션 [E]-->
...
<div class="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12 pb-24">
  ...
  <div class="mb-12 border-b border-slate-900">
     <nav class="-mb-px flex space-x-8" aria-label="Tabs">
       ...
       <a href="<?=$default_path?>/business/business.php" class="border-brand-500 text-brand-400 whitespace-nowrap border-b-2 py-4 px-1 text-sm font-semibold transition">운영쇼핑몰</a>
  ...
  <div class="space-y-20">
     ...
     <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <!-- 쇼핑몰 1: 도루코공식몰 -->
        <div class="group relative flex flex-col justify-between rounded-3xl border border-slate-900 bg-slate-900/10 overflow-hidden hover:border-slate-800 hover:bg-slate-900/20 hover:shadow-2xl hover:shadow-brand-500/5 transition duration-300">
           <a href="<?=$default_path?>/business/business.php?com_board_basic=read_form&com_board_idx=8&&com_board_search_code=&com_board_search_value1=&com_board_search_value2=&com_board_page=&&com_board_id=4&&com_board_id=4" class="block overflow-hidden bg-slate-950">
           ...
           <div class="p-6 space-y-4">
              <div class="flex items-center justify-between">
                 <span class="inline-flex items-center rounded-md bg-brand-500/10 px-2.5 py-1 text-xs font-medium text-brand-400 ring-1 ring-inset ring-brand-500/20">도루코 (DORCO)</span>
                 <span class="inline-flex items-center rounded-md bg-emerald-500/10 px-2.5 py-1 text-xs font-medium text-emerald-400 ring-1 ring-inset ring-emerald-500/20">운영 중</span>
              </div>
              <h4 class="font-display text-lg font-bold text-white group-hover:text-brand-400 transition">
              ...
              <p class="text-xs text-slate-400 leading-relaxed">도루코 정품 칼, 가위 및 주방 위생용품을 판매하는 네이버 스마트스토어 공식 대행 스토어입니다.</p>
           </div>
        </div>

        <!-- 쇼핑몰 2: 동원천지인공식몰 -->
        <div class="group relative flex flex-col justify-between rounded-3xl border border-slate-900 bg-slate-900/10 overflow-hidden hover:border-slate-800 hover:bg-slate-900/20 hover:shadow-2xl hover:shadow-brand-500/5 transition duration-300">
           <a href="<?=$default_path?>/business/business.php?com_board_basic=read_form&com_board_idx=7&&com_board_search_code=&com_board_search_value1=&com_board_search_value2=&com_board_page=&&com_board_id=4&&com_board_id=4" class="block overflow-hidden bg-slate-950">
           ...
           <div class="p-6 space-y-4">
              <div class="flex items-center justify-between">
                 <span class="inline-flex items-center rounded-md bg-indigo-500/10 px-2.5 py-1 text-xs font-medium text-indigo-400 ring-1 ring-inset ring-indigo-500/20">동원F&B</span>
                 <span class="inline-flex items-center rounded-md bg-emerald-500/10 px-2.5 py-1 text-xs font-medium text-emerald-400 ring-1 ring-inset ring-emerald-500/20">운영 중</span>
              </div>
              <h4 class="font-display text-lg font-bold text-white group-hover:text-brand-400 transition">
              ...
              <p class="text-xs text-slate-400 leading-relaxed">동원 F&B의 고품격 홍삼 브랜드 천지인을 유통하는 스마트스토어 및 오픈마켓 공식 벤더샵입니다.</p>
           </div>
        </div>

        <!-- 쇼핑몰 3: 그란도노공식몰 -->
        <div class="group relative flex flex-col justify-between rounded-3xl border border-slate-900 bg-slate-900/10 overflow-hidden hover:border-slate-800 hover:bg-slate-900/20 hover:shadow-2xl hover:shadow-brand-500/5 transition duration-300">
           <a href="<?=$default_path?>/business/business.php?com_board_basic=read_form&com_board_idx=6&&com_board_search_code=&com_board_search_value1=&com_board_search_value2=&com_board_page=&&com_board_id=4&&com_board_id=4" class="block overflow-hidden bg-slate-950">
           ...
           <div class="p-6 space-y-4">
              <div class="flex items-center justify-between">
                 <span class="inline-flex items-center rounded-md bg-violet-500/10 px-2.5 py-1 text-xs font-medium text-violet-400 ring-1 ring-inset ring-violet-500/20">그란도노 (Grandono)</span>
                 <span class="inline-flex items-center rounded-md bg-emerald-500/10 px-2.5 py-1 text-xs font-medium text-emerald-400 ring-1 ring-inset ring-emerald-500/20">운영 중</span>
              </div>
              <h4 class="font-display text-lg font-bold text-white group-hover:text-brand-400 transition">
              ...
              <p class="text-xs text-slate-400 leading-relaxed">이탈리아 명품 패션 및 슈즈 수입 직구 전문 프리미엄 쇼핑몰입니다.</p>
           </div>
        </div>
     ...
     <div class="relative overflow-hidden rounded-3xl bg-gradient-to-r from-slate-900 to-indigo-950/40 border border-slate-900 p-8 sm:p-12 flex flex-col md:flex-row items-center justify-between gap-6">
        <div class="space-y-2 text-center md:text-left">
           <h4 class="font-display text-xl font-extrabold text-white">귀사 브랜드의 가치를 100% 디지털로 이식해 드리겠습니다.</h4>
           <p class="text-sm text-slate-400">도루코, 동원 천지인과 같이 신뢰도 높은 쇼핑몰 운영 전략을 이식받으십시오.</p>
        </div>
