...
<section class="relative mx-auto max-w-7xl px-6 sm:px-8 lg:px-12 pt-16 pb-8">
  <div class="border-b border-slate-900 pb-10">
    <span class="text-xs font-semibold uppercase tracking-wider text-emerald-400">SMARTSTORE AGENCY</span>
    <h1 class="mt-2 font-display text-4xl font-extrabold tracking-tight text-white sm:text-5xl">스마트스토어 에이전시</h1>
    <p class="mt-4 text-base text-slate-400">네이버 스마트스토어의 핵심 노하우를 제공하며 최상의 이커머스 브랜딩을 실현합니다.</p>
  </div>
</section>
<!-- 상단 서브 히어로 섹션 [E]-->
...
<div class="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12 pb-24">
  ...
  <div class="mb-12 border-b border-slate-900">
     <nav class="-mb-px flex space-x-8" aria-label="Tabs">
       <a href="<?=$default_path?>/naver/smartstore.php" class="border-brand-500 text-brand-400 whitespace-nowrap border-b-2 py-4 px-1 text-sm font-semibold transition">스마트스토어</a>
     </nav>
  </div>
  <!-- 상단 탭 메뉴 [E] -->
  ...
  <div class="space-y-20">
     ...
     <div class="grid grid-cols-1 gap-12 lg:grid-cols-12 items-center">
        <!-- 네이버 로고 데코 카드 -->
        <div class="lg:col-span-5 relative overflow-hidden rounded-3xl border border-emerald-950/30 bg-emerald-950/10 p-8 flex flex-col justify-center items-center text-center h-64 sm:h-80 shadow-xl">
           <!-- 미세한 초록 그라데이션 광원 -->
           <div class="absolute inset-0 bg-gradient-to-tr from-emerald-500/10 via-transparent to-transparent"></div>
           <div class="relative space-y-4">
              <span class="text-xs font-semibold text-emerald-400 uppercase tracking-widest">DOMESTIC NO.1 MARKET</span>
              <h3 class="font-display text-3xl font-black text-white leading-tight">네이버 스마트스토어</h3>
              <p class="text-sm text-emerald-100/60 leading-relaxed max-w-xs">국내 최대 유통 거래액을 자랑하는 독보적 커머스 플랫폼</p>
           </div>
        </div>
        
        <!-- 네이버 분석 데이터 요약 -->
        <div class="lg:col-span-7 space-y-6">
           <h3 class="font-display text-2xl sm:text-3xl font-extrabold text-white leading-tight">네이버! 국내 최대 이커머스 리더</h3>
           ...
           <!-- 통계 그리드 -->
           <div class="grid grid-cols-3 gap-4 border-t border-slate-900 pt-6">
              <div>
                 <span class="block text-2xl font-extrabold text-white font-display">28조+</span>
                 <span class="mt-1 block text-xs text-slate-500 font-medium">연간 총 거래액</span>
              </div>
              <div>
                 <span class="block text-2xl font-extrabold text-white font-display">42만+</span>
                 <span class="mt-1 block text-xs text-slate-500 font-medium">개설 스토어 수</span>
              </div>
              <div>
                 <span class="block text-2xl font-extrabold text-brand-400 font-display">25조+</span>
     ...
     <div class="space-y-8">
        <div class="text-center space-y-2">
          <h4 class="font-display text-2xl font-extrabold text-white">브랜드사는 왜 스마트스토어를 운영해야 할까요?</h4>
          <p class="text-sm text-slate-400">네이버만의 강력한 마케팅 리소스와 노출 환경을 통해 자사몰 대비 획기적인 성장 기회를 가집니다.</p>
        </div>
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
           ...
           <div class="rounded-3xl border border-slate-900 bg-slate-900/10 p-8 space-y-4 hover:border-slate-800 transition duration-300 flex gap-5 items-start">
              ...
              <div class="space-y-2">
                 <h5 class="text-lg font-bold text-white leading-none">1. 네이버만의 확실한 무료 노출 구좌</h5>
                 <p class="text-sm text-slate-400 leading-relaxed">네이버 이커머스는 기획전, 럭키투데이, 타임특가 등 입점 스토어를 위한 다양한 무료 노출 구좌를 지원합니다. 특히 단시간에 트래픽을 폭발시키는 타임특가는 최고의 무료 마케팅 무기입니다.</p>
              </div>
           </div>
           ...
           <div class="rounded-3xl border border-slate-900 bg-slate-900/10 p-8 space-y-4 hover:border-slate-800 transition duration-300 flex gap-5 items-start">
              ...
              <div class="space-y-2">
                 <h5 class="text-lg font-bold text-white leading-none">2. 매출 스파이크를 만드는 브랜드데이</h5>
                 <p class="text-sm text-slate-400 leading-relaxed">자체 브랜드를 보유한 정식 본사만 참여 자격을 얻는 브랜드데이 프로모션은 단 하루 만에 수억 원대의 매출 스파이크를 창출합니다. 최상단 노출 및 네이버 커머스 실무 MD들과의 원활한 사전 협력이 관건입니다.</p>
              </div>
           </div>
           ...
           <div class="rounded-3xl border border-slate-900 bg-slate-900/10 p-8 space-y-4 hover:border-slate-800 transition duration-300 flex gap-5 items-start">
              ...
              <div class="space-y-2">
                 <h5 class="text-lg font-bold text-white leading-none">3. 스마트스토어 쇼핑라이브 (Live Commerce)</h5>
                 <p class="text-sm text-slate-400 leading-relaxed">스토어가 파워등급 이상 도달하면 네이버 자체 쇼핑라이브를 송출할 수 있습니다. 수만 명의 고객과 실시간 채팅으로 양방향 소통하며 소구 포인트를 설명해 구매 전환 속도를 극대화합니다.</p>
              </div>
           </div>
           ...
           <div class="rounded-3xl border border-slate-900 bg-slate-900/10 p-8 space-y-4 hover:border-slate-800 transition duration-300 flex gap-5 items-start">
              ...
              <div class="space-y-2">
                 <h5 class="text-lg font-bold text-white leading-none">4. 네이버 쇼핑 탭 검색 랭킹 우위 선점</h5>
                 <p class="text-sm text-slate-400 leading-relaxed">네이버 검색 엔진은 자사 독립몰 대비 스마트스토어를 훨씬 상위 영역에 매핑합니다. 판매 점수 및 리뷰 지수가 우적되면 별도의 키워드 광고비 없이도 카테고리 1페이지 노출을 선점할 수 있습니다.</p>
              </div>
           </div>
     ...
     <div class="space-y-8">
        <div class="text-center space-y-2">
           <h4 class="font-display text-2xl font-extrabold text-white">그렇다면 정답은 <span class="text-brand-400">조이코리아</span></h4>
           <p class="text-sm text-slate-400">스마트스토어는 운영사의 등급, 마케팅 능력, 그리고 MD 네트워크에 따라 완전히 다른 매출 결과를 만듭니다.</p>
        </div>
        
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
           
           <!-- 강점 1 -->
           <div class="rounded-3xl border border-slate-900 bg-slate-900/10 p-8 space-y-4 hover:border-slate-800 transition duration-300">
              <div class="flex h-10 w-10 items-center justify-center rounded-xl bg-brand-500/10 text-brand-400">
                 <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" /></svg>
              </div>
              <h5 class="text-base font-bold text-white">빅파워&middot;프리미엄 등급 전담 마크</h5>
              <p class="text-xs text-slate-400 leading-relaxed">스토어 평균 등급이 높을수록 네이버 플랫폼에서 더 강력한 노출 혜택과 프로모션 자격을 가집니다. 조이코리아는 빅파워 이상의 최상위 스토어들을 전담 운영하고 있습니다.</p>
           </div>
           ...
           <div class="rounded-3xl border border-slate-900 bg-slate-900/10 p-8 space-y-4 hover:border-slate-800 transition duration-300">
              ...
              <h5 class="text-base font-bold text-white">네이버 커머스 MD 파트너십 채널 소통</h5>
              <p class="text-xs text-slate-400 leading-relaxed">조이코리아의 실무 전담 매니저들은 네이버 카테고리 담당 MD들과 매주 기획전 배정 및 특가 편성을 정기적으로 논의하여 타사 대비 유리한 프로모션 기회를 선점합니다.</p>
           </div>
           ...
           <div class="rounded-3xl border border-slate-900 bg-slate-900/10 p-8 space-y-4 hover:border-slate-800 transition duration-300">
              ...
              <h5 class="text-base font-bold text-white">리뷰 마케팅 & 데이터 그로스</h5>
              <p class="text-xs text-slate-400 leading-relaxed">스토어 유입 고객의 구매 허들을 낮추기 위해 검색 상위 노출에 기여하는 정밀 리뷰 락 마케팅 및 전환율 기반 그로스 해킹 지표 피드백을 실시간 제공합니다.</p>
           </div>
     ...
     <div class="space-y-8">
        <div class="border-b border-slate-900 pb-3">
          <h4 class="font-display text-xl font-bold text-white">스마트스토어 운영 PROCESS</h4>
        </div>
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-6 relative">
           ...
           <div class="rounded-2xl border border-slate-900 bg-slate-900/10 p-6 space-y-3 relative">
              ...
              <h5 class="text-sm font-bold text-white pt-2">스토어 정밀 진단</h5>
              <p class="text-xs text-slate-400 leading-relaxed">기존 스토어 진단, 카테고리 검색 반응 분석 및 타사 벤치마킹</p>
           </div>
           ...
           <div class="rounded-2xl border border-slate-900 bg-slate-900/10 p-6 space-y-3 relative">
              ...
              <h5 class="text-sm font-bold text-white pt-2">콘텐츠 기획 최적화</h5>
              <p class="text-xs text-slate-400 leading-relaxed">대표 썸네일 개선, 모바일 최적화 상세페이지 제작 및 SEO 키워드 파싱</p>
           </div>
           ...
           <div class="rounded-2xl border border-slate-900 bg-slate-900/10 p-6 space-y-3 relative">
              ...
              <h5 class="text-sm font-bold text-white pt-2">네이버 노출 영업</h5>
              <p class="text-xs text-slate-400 leading-relaxed">스마트스토어 럭키투데이, 쇼핑 기획전 제안 및 타임특가 구좌 노출</p>
           </div>
           ...
           <div class="rounded-2xl border border-slate-900 bg-slate-900/10 p-6 space-y-3 relative">
              ...
              <h5 class="text-sm font-bold text-white pt-2">검색 쇼핑광고 집행</h5>
              <p class="text-xs text-slate-400 leading-relaxed">쇼핑 검색 광고 최적화 세팅, 파워링크 및 맞춤 타겟 리타겟팅 광고</p>
           </div>
           ...
           <div class="rounded-2xl border border-slate-900 bg-slate-900/10 p-6 space-y-3 relative">
              ...
              <h5 class="text-sm font-bold text-white pt-2">물류 및 실시간 CS</h5>
              <p class="text-xs text-slate-400 leading-relaxed">실시간 자동 발주 연동, 당일 배송 지시 및 평점 관리 전문 CS 마크</p>
           </div>
           ...
           <div class="rounded-2xl border border-slate-900 bg-slate-900/10 p-6 space-y-3 relative">
              ...
              <h5 class="text-sm font-bold text-white pt-2">데이터 피드백 성과</h5>
              <p class="text-xs text-slate-400 leading-relaxed">월간 판매 추이 및 유입 데이터 분석을 거친 스토어 확장 솔루션 리포팅</p>
           </div>
     ...
     <div class="relative overflow-hidden rounded-3xl bg-gradient-to-r from-slate-900 to-emerald-950/40 border border-slate-900 p-8 sm:p-12 flex flex-col md:flex-row items-center justify-between gap-6">
        <div class="space-y-2 text-center md:text-left">
           <h4 class="font-display text-xl font-extrabold text-white">네이버 스마트스토어의 성장을 보증해 드리겠습니다.</h4>
           <p class="text-sm text-slate-400">스토어 입점 가능성 진단부터 프로모션 매출 계획안을 실시간 전문가 진단으로 상담해 드립니다.</p>
        </div>
