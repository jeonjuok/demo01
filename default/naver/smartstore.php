...
<!-- 상단 탭메뉴 [E] -->
   ...
   <div class="sub-content">
      <div class="title-box container">
        <h3>스마트스토어 운영 에이전시</h3>
        <p class="navi"><i class="fa fa-home"></i> <span class="arrow-pd"><i class="fa fa-angle-right"></i></span> 스마트스토어 <span class="arrow-pd"><i class="fa fa-angle-right"></i></span> 스마트스토어</p>
      </div>
      ...
      <div class="company container clearfix lg-bottom wow fadeInUp">
         ...
         <!-- 설명글 -->
         <div class="txt">
            <p class="tit"><span style = "color: #00c73c;">네이버!</span> 국내 최대 이커머스 리더!</p><br/>
            <p class="sub_txt"><strong class="first_word">네이버는</strong>
다양성의 가치를 품은 견고한 이커머스 시장의 리더로서 지난해<strong class="first_word"> 28조원의 거래액</strong>을 달성하며 국내 이커머스 시장 1위를 확고히 하고 있습니다. 
현재까지 개설된 <strong class="first_word"> 스마트스토어 수는 42만개</strong>를 넘어섰으며, 연간 스마트스토어를 통해 거래되는 대금이 17조원을 넘어설 만큼 스마트스토어는 한국에서 가장 인기있는 온라인 플랫폼입니다.<br/>
향후 네이버의 스마트스토어 목표액은 25조이상의 거래액과 100만개의 스마트스토어를 목표로 하고 있습니다.</p>
         </div>              
       </div>
            ...
            <li>
               ...
               <div class="txt">
                  ...
                  <p>네이버에는 여러가지 무료 노출구좌가 있습니다. 기획전, 럭키투데이, 핫딜, 타임특가등 그중 효과나 매출면에서 단연 우위에 있는 타임특가.                     
                     &nbsp;유료구좌가 아닌 무료로도 폭발적인 매출을 일으킬 수 있는 네이버만의 독보적인 서비스입니다.</p>
               </div>
            </li>
            <li>
               ...
               <div class="txt">
                  ...
                  <p>브랜드를 소유하고 있는 기업체만 참여할 수 있는 브랜드데이. 월별, 시즌별로 기획하여 단 하루 진행하며 잘 진행될 경우 억단위 매출이 일어납니다.
                     타임특가 및 브랜드데이등 네이버만의 기획행사에 참여하기 위해서는 네이버MD와 유기적인 업무 소통이 중요합니다.</p>
               </div>
            </li>
            <li>
               ...
               <div class="txt">
                  ...
                  <p> 네이버 판매를 통해 스마트스토어가 파워등급 이상일때 라이브커머스를 진행 할 수 있습니다. 판매자와 고객이 실시간 소통하며 제품을 판매하고, 귀사의 브랜드를 홍보할 수 있습니다.
                      라이브커머스 시장은 앞으로 이커머스 시장의 한 축으로 계속 성장 할 것입니다.</p>
               </div>
            </li>
            <li>
               ...
               <div class="txt">
                  ...
                  <p>네이버의 다양한 광고를 통해 네이버 상단에 노출될 수 있으며, 네이버에서 상품 검색 시 스마트스토어가 자사몰 대비 상위로 노출되어 구매전환이 용이합니다.
                     브랜드사의 자사몰은 광고를 통해 유입되는 것과는 달리 스마트스토어는 판매지수가 높아지면 광고를 진행하지 않아도 첫페이지에 노출 될 수 있습니다.</p>
               </div>
            </li>
         </ul>
